...
const Home: React.FC = () => {
  // التحكم بالموسيقى موحّد في المشغل العام (GlobalAudioPlayer) لتفادي
  // تعارض تشغيل مقطعين صوتيين في وقت واحد. هذا الزر يرسل حدثاً
  // يلتقطه المشغل العام فيبدأ التشغيل بعد أول تفاعل من المستخدم
  // (المتصفحات تحظر autoplay بدون تفاعل، لذا لا نحاول التشغيل التلقائي هنا).
  const toggleAudio = () => {
    window.dispatchEvent(new CustomEvent('md1usd:toggleAudio'));
  };
  ...
  const stats = [
    ...
    { label: 'الرسوم', value: '0.1%', icon: '💰' },
    { label: 'الأمان', value: 'مدقق', icon: '🔐' },
  ];

  const benefits = [
    {
      title: 'متوافق شرعياً',
      description: 'تم فحص MD1USD من قبل خبراء الشريعة الإسلامية',
      icon: '✨',
    },
    {
      title: 'سيولة عالية',
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-fadeInUp">
              ...
              <p className="text-lg text-gray-400 mb-8">
                نظام عملة مستقرة لا مركزي وموثوق يعتمد على العقود الذكية والاحتياطيات المعلنة، متوافق تماماً مع الشريعة الإسلامية.
              </p>
              ...
              <div className="mt-12 flex gap-6 flex-wrap">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-300">موافق شرعياً</span>
                </div>
                <div className="flex items-center gap-2">
      ...
      <section className="py-20 bg-black-900 border-y border-gold-500/20">
        <div className="container-custom">
          <h2 className="text-4xl font-bold text-white mb-4 text-center">
            شاهد <span className="gradient-text">MD1USD</span> في دقيقتين
          </h2>
          <p className="text-gray-400 text-center mb-10 max-w-2xl mx-auto">
            فيديو تعريفي قصير يشرح كيف تعمل العملة المستقرة MD1USD ولماذا هي مختلفة
          </p>
          <div className="max-w-3xl mx-auto">
            <MediaVideo
              src="/videos/pages/home/intro_md1usd.webm"
              title="فيديو تعريفي بـ MD1USD"
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-black-950">
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            />
            <MediaImage
              src="/images/gold_coin_md1usd.png"
