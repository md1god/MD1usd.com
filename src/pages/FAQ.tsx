...
const FAQ: React.FC = () => {
  ...
  const faqs = [
    { q: 'ما هو MD1USD؟', a: 'عملة مستقرة (Stablecoin) مضمونة بالكامل بأصول حقيقية بنسبة 1:1، ومصممة لتكون متوافقة مع الشريعة الإسلامية ومنشورة على عدة شبكات بلوكتشين.' },
    ...
    { q: 'ما الشبكات التي تدعم MD1USD؟', a: 'حالياً Ethereum وPolygon وBNB Chain بشكل نشط بالكامل، بينما Solana منشورة على الشبكة الرئيسية وقيد التفعيل الكامل.' },
