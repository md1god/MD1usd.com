...
const Footer: React.FC = () => {
  ...
  const sisterLinks = [
    { label: 'منصة MDM1 الرئيسية', url: 'https://mdm1.org' },
    { label: 'الصراف الآلي (ATM)', url: 'https://mdm1.org/pages/ATM.html' },
    { label: 'لوحة النقاش', url: 'https://mdm1.org/pages/ideas.html' },
    { label: 'تسجيل الدخول / الانضمام', url: 'https://mdm1.org/pages/join.html' },
  ];

  const socialLinks = [
    { icon: '𝕏', label: 'X (Twitter)', url: 'https://twitter.com/MDm111000000' },
    { icon: '📱', label: 'Telegram', url: 'https://t.me/md1god' },
    { icon: '▶', label: 'YouTube', url: 'https://www.youtube.com/@MD-m1' },
    { icon: '🎵', label: 'TikTok', url: 'https://tiktok.com/@md1usd' },
    { icon: '🐙', label: 'GitHub', url: 'https://github.com/md1god/MD1usd.com' },
  ];
  ...
  return (
    <footer className="bg-black-950 text-white border-t-2 border-gold-500">
      ...
      <div className="container-custom py-16">
        <div className="grid md:grid-cols-6 gap-8 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 text-sm">
              عملة مستقرة مضمونة 100% باحتياطي حقيقي، بعقود مفتوحة المصدر وشفافة بالكامل
            </p>
          </div>

          {/* Sister site links */}
          <div>
            <h4 className="text-blue-400 font-bold mb-4">منصة MDM1</h4>
        ...
        {/* Contact emails */}
        <div className="border-t border-gold-500/30 pt-8 mb-8 flex flex-wrap gap-6 text-sm">
          <a href="mailto:info@md1usd.com" className="text-gray-400 hover:text-gold-500 transition-colors">✉️ info@md1usd.com</a>
          <a href="mailto:info@mdm1.org" className="text-gray-400 hover:text-gold-500 transition-colors">✉️ info@mdm1.org</a>
        </div>
        ...
        <div className="border-t border-gold-500/30 pt-8">
          <div className="flex flex-wrap justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} MD1USD. جميع الحقوق محفوظة.
            </p>
