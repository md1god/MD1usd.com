  ...
  return (
    <div className="min-h-screen bg-black-950">
      ...
      <section className="py-20 bg-black-950">
        <div className="container-custom">
          <h2 className="text-3xl font-bold text-white mb-4 text-center">لقاء مع خبير في التمويل الإسلامي الرقمي</h2>
          <p className="text-gray-400 text-center mb-10 max-w-2xl mx-auto">فيديو يناقش معايير التوافق الشرعي في العملات المستقرة</p>
          <div className="max-w-3xl mx-auto">
            <MediaVideo src="/videos/pages/islamic-finance/shariah_compliance_interview.webm" title="مقابلة حول التوافق الشرعي" />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-black-900">
        <div className="container-custom">
          <h2 className="text-3xl font-bold text-white mb-10 text-center">شهادة التوافق الشرعي</h2>
          <MediaImage
            src="/images/pages/islamic-finance/shariah_certificate.png"
            alt="شهادة أو مخطط التوافق الشرعي لـ MD1USD"
            aspect="aspect-[4/3]"
