...
const Whitepaper: React.FC = () => {
  const sections = [
    {
      ...
      body: 'يهدف MD1USD إلى تقديم عملة مستقرة (Stablecoin) موثوقة وشفافة بالكامل، مصممة على مبادئ مالية أخلاقية عامة، تتيح للأفراد والمشاريع تخزين القيمة والتحويل عبر البلوكتشين دون التعرض لتقلبات العملات الرقمية التقليدية. الرؤية طويلة المدى هي بناء نظام اقتصادي لا مركزي تُدار قواعده بالكود لا بالأشخاص.',
    },
    {
      num: '2',
    ...
    },
    {
      num: '5',
      title: 'خارطة الطريق',
      body: 'تشمل الخطوات القادمة توسيع السيولة عبر منصات تبادل لامركزية إضافية، والمزيد من تطبيقات DeFi، وتطوير أدوات مجتمعية للحوكمة اللامركزية عبر توكن MDM1. راجع صفحة خارطة الطريق للتفاصيل الزمنية الكاملة.',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-black-950">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-12 p-8 bg-black-800 rounded-xl border border-gold-500/30 text-center">
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                ...
                <a href="https://mdm1.org/whitepaper.html" target="_blank" rel="noopener noreferrer" className="btn-blue inline-block">
                  الرسالة ↗
                </a>
              </div>
              <p className="text-gray-500 text-xs mt-4">
                "الرسالة" هي الورقة البيضاء الأوسع لمنظومة MDM1 الكاملة على mdm1.org
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-black-900 text-center">
        <div className="container-custom">
          <a href="https://mdm1.org/pages/md1usd.html" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">
            صفحة MD1USD الكاملة على mdm1.org ↗
          </a>
        </div>
      </section>
