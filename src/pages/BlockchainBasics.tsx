    ...
    <div className="min-h-screen bg-black-950">
      ...
      <section className="py-20 bg-black-900">
        <div className="container-custom">
          <h2 className="text-3xl font-bold text-white mb-4 text-center">كيف يعمل البلوكتشين؟</h2>
          <p className="text-gray-400 text-center mb-10 max-w-2xl mx-auto">فيديو متحرك يبسّط الفكرة لغير المتخصصين</p>
          <div className="max-w-3xl mx-auto">
            <MediaVideo src="/videos/pages/blockchain-basics/how_blockchain_works.webm" title="كيف يعمل البلوكتشين" />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-black-900">
        <div className="container-custom">
          ...
          <MediaImage
            src="/images/blockchain_spirit_new.png"
