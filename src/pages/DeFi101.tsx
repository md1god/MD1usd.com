    ...
    <div className="min-h-screen bg-black-950">
      ...
      <section className="py-20 bg-black-900">
        <div className="container-custom">
          <h2 className="text-3xl font-bold text-white mb-4 text-center">اشرح لي DeFi في دقيقتين</h2>
          <p className="text-gray-400 text-center mb-10 max-w-2xl mx-auto">فيديو تعليمي مبسط لغير المتخصصين</p>
          <div className="max-w-3xl mx-auto">
            <MediaVideo src="/videos/pages/defi101/defi_explained.webm" title="شرح مبسط لمفهوم DeFi" />
          </div>
        </div>
      </section>
